...
3. **Set up the remote and worktree**:
   ...
   - Create worktree: `git worktree add -b BRANCHNAME ~/wt/project/SHORT_NAME USERNAME/BRANCHNAME`
...
4. **Configure the worktree**:
   ...
   - Initialize any project-specific tooling in the worktree
...
- Create worktree at `~/wt/project/eng-1696`
